...
extern "C" {
    ...
    {
        ERESULT         eRc;
        TBLC_DATA   *pObject = OBJ_NIL;
        const
        OBJ_INFO        *pInfo;
        //int64_t         intIn;
        //ASTR_DATA       *pWrk;

        pInfo = obj_getInfo(TblC_Class());
        ...
        eRc =  TblC_ParseJsonFields(pParser, pObject);
    ...
    )
    {
        ...
        pObject = TblC_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = TblC_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = TblC_ToJsonFields(this, pStr);      
