...
extern "C" {
    ...
    {
        ERESULT         eRc;
        TBLP_DATA   *pObject = OBJ_NIL;
        const
        OBJ_INFO        *pInfo;
        //int64_t         intIn;
        //ASTR_DATA       *pWrk;

        pInfo = obj_getInfo(TblP_Class());
        ...
        eRc =  TblP_ParseJsonFields(pParser, pObject);
    ...
    )
    {
        ...
        pObject = TblP_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = TblP_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = TblP_ToJsonFields(this, pStr);      
