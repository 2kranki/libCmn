...
extern "C" {
...
#ifdef XYZZY
    static
    void            GenWin_task_body (
        void            *pData
    )
    {
        //GENWIN_DATA  *this = pData;
    ...
    ****************************************************************/
    ...
    /*!
     ...
     Example:
     @code 
        ERESULT eRc = GenWin_Assign(this,pOther);
     @endcode 
    ...
    /*!
     ...
     @endcode 
     @param     this    GENWIN object pointer
     @return    If successful, a GENWIN object which must be 
    ...
    )
    {
        ...
        //          in 'this' yet.
       if (this) {
            if (obj_IsKindOf(this, OBJ_IDENT_GENWIN))
                ;
            else {
