...
extern "C" {
    ...
    typedef enum obj_genObject_idents_e {
        ...
        OBJ_IDENT_CLASSFILE,
        OBJ_IDENT_CLASSFILE_CLASS,
        OBJ_IDENT_CLASSITEM,
        OBJ_IDENT_CLASSITEM_CLASS,
        OBJ_IDENT_CLASSITEMS,
        OBJ_IDENT_CLASSITEMS_CLASS,
        OBJ_IDENT_DICT,
        OBJ_IDENT_DICT_CLASS,
        OBJ_IDENT_ENUMFILE,
        OBJ_IDENT_ENUMFILE_CLASS,
        OBJ_IDENT_ENUMITEM,
        OBJ_IDENT_ENUMITEM_CLASS,
        OBJ_IDENT_ENUMITEMS,
        OBJ_IDENT_ENUMITEMS_CLASS,
        OBJ_IDENT_GEN,
        OBJ_IDENT_GEN_CLASS,
        OBJ_IDENT_GENITEM,
        ...
        OBJ_IDENT_PROPFILE,
        OBJ_IDENT_PROPFILE_CLASS,
        OBJ_IDENT_PROPITEM,
        OBJ_IDENT_PROPITEM_CLASS,
        OBJ_IDENT_PROPITEMS,
        OBJ_IDENT_PROPITEMS_CLASS,
        OBJ_IDENT_SRCPARSE,
...
#define OBJECT_NAME         "NAMEL"
#define OBJECT_NAME_UPPER   "NAMEU"
#define OUTPUT_DRIVE        "OUTPUT_DRIVE"
#define OUTPUT_DIR          "OUTPUT_DIR"
#define SUPER_NAME          "SUPERL"
#define SUPER_NAME_UPPER    "SUPERU"
