...
typedef struct srcFiles_class_data_s SRCFILES_CLASS_DATA;
...
SRCFILES_CLASS_DATA  srcFiles_ClassObj = {
    {&obj_Vtbl, sizeof(OBJ_DATA), OBJ_IDENT_SRCFILES_CLASS, 0, 1},
	//0
};
