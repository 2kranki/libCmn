...
extern "C" {
    ...
    )
    {
        ...
        pInfo = obj_getInfo(CmdProc_Class());
        ...
        eRc =  CmdProc_ParseJsonFields(pParser, pObject);
    ...
    )
    {
        ...
        pObject = CmdProc_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = CmdProc_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = CmdProc_ToJsonFields(this, pStr);      
