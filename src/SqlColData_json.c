...
extern "C" {
    ...
    {
        ERESULT         eRc;
        SQLCOLDATA_DATA   *pObject = OBJ_NIL;
        const
        OBJ_INFO        *pInfo;
        //int64_t         intIn;
        //ASTR_DATA       *pWrk;
        ...
        pInfo = obj_getInfo(SqlColData_Class());
        ...
        pObject = SqlColData_New( );
        if (OBJ_NIL == pObject) {
            goto exit00;
        }
        
        eRc =  SqlColData_ParseJsonFields(pParser, pObject);
    ...
    )
    {
        ...
        pObject = SqlColData_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = SqlColData_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = SqlColData_ToJsonFields(this, pStr);      
