...
extern "C" {
    ...
    )
    {
        ...
        eRc =  Cmd_ParseJsonFields(pParser, pObject);
    ...
    )
    {
        ...
        pObject = Cmd_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = Cmd_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = Cmd_ToJsonFields(this, pStr);      
