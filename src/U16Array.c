...
extern "C" {
    ...
    ****************************************************************/
    ...
    )
    {
        ...
        this = (OBJ_ID)obj_Init(this, cbSize, OBJ_IDENT_U16ARRAY);
        if (OBJ_NIL == this) {
            DEBUG_BREAK();
            obj_Release(this);
            return OBJ_NIL;
