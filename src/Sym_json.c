...
extern "C" {
    ...
    )
    {
        ...
        JsonOut_Append_i64("value", this->value, pStr);
#elif defined(__WIN32_ENV__) || defined(__WIN64_ENV__)
        JsonOut_Append_i64("value", this->value, pStr);
#else
        JsonOut_Append_i32("value", this->value, pStr);
#endif
        JsonOut_Append_u8("abs", this->fAbs, pStr);
        JsonOut_Append_u8("rel", this->fRel, pStr);
#ifdef XYZZZY
