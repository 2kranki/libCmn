...
extern "C" {
    ...
    {
        ERESULT         eRc;
        SYMS_DATA   *pObject = OBJ_NIL;
        const
        OBJ_INFO        *pInfo;
        //int64_t         intIn;
        //ASTR_DATA       *pWrk;

        pInfo = obj_getInfo(Syms_Class());
        ...
        eRc =  Syms_ParseJsonFields(pParser, pObject);
    ...
    )
    {
        ...
        pObject = Syms_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = Syms_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = Syms_ToJsonFields(this, pStr);      
