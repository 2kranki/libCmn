...
extern "C" {
    ...
    )
    {
        ...
        pInfo = obj_getInfo(SqlTbl_Class());
        ...
        eRc =  SqlTbl_ParseJsonFields(pParser, pObject);
    ...
    )
    {
        ...
        pObject = SqlTbl_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = SqlTbl_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = SqlTbl_ToJsonFields(this, pStr);      
