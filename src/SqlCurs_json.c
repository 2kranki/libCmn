...
extern "C" {
    ...
    )
    {
        ...
        {
            ASTR_DATA       *pStr = SqlCurs_ToDebugString(pParser, 4);
            fprintf(stderr, "Base:\n%s\n\n", AStr_getData(pStr));
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    {
        ERESULT         eRc;
        SQLCURS_DATA   *pObject = OBJ_NIL;
        const
        OBJ_INFO        *pInfo;
        //int64_t         intIn;
        //ASTR_DATA       *pWrk;

        pInfo = obj_getInfo(SqlCurs_Class());
        ...
        eRc =  SqlCurs_ParseJsonFields(pParser, pObject);
    ...
    )
    {
        ...
        pObject = SqlCurs_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = SqlCurs_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = SqlCurs_ToJsonFields(this, pStr);      
