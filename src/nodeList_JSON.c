...
extern "C" {
    ...
    ERESULT         nodeList_NewFromJSONString(
        ASTR_DATA       *pString,
        NODELIST_DATA   **ppData
    )
    {
    ...
    ERESULT         nodeList_NewFromJSONStringA(
        const
        char            *pString,
        NODELIST_DATA   **ppData
    )
    {
        ...
        if (pString) {
            ...
            eRc = nodeList_NewFromJSONString(pStr, ppData);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
