...
extern "C" {
...
#ifdef XYZZY
    static
    void            Lex05_task_body (
        void            *pData
    )
    {
        //LEX05_DATA  *this = pData;
    ...
    ****************************************************************/
    ...
    {
        LEX05_DATA       *this;
        uint32_t        cbSize = sizeof(LEX05_DATA);
    ...
    uint32_t        Lex05_getFlags(
        LEX05_DATA      *this
    )
    {
#ifdef NDEBUG
#else
        if( !Lex05_Validate(this) ) {
            DEBUG_BREAK();
        }
#endif
    ...
    /*!
     ...
     Example:
     @code 
        ERESULT eRc = Lex05_Assign(this,pOther);
     @endcode 
     @param     this    object pointer
     @param     pOther  a pointer to another LEX05 object
    ...
    /*!
     ...
     Example:
     @code 
        Lex05      *pCopy = Lex05_Copy(this);
     @endcode 
     @param     this    object pointer
     @return    If successful, a LEX05 object which must be 
...
#ifdef LEX05_IS_IMMUTABLE
        obj_Retain(this);
        pOther = this;
#else
        pOther = Lex05_New( );
        if (pOther) {
            eRc = Lex05_Assign(this, pOther);
    ...
    )
    {
        ...
        if (obj_IsEnabled(this)) {
            ((LEX05_VTBL *)obj_getVtbl(this))->devVtbl.pStop((OBJ_DATA *)this,NULL);
        }
#endif

        Lex05_setStr(this, OBJ_NIL);
    ...
    /*!
     ...
     Example:
     @code 
        Lex05      *pDeepCopy = Lex05_Copy(this);
     @endcode 
     @param     this    object pointer
     @return    If successful, a LEX05 object which must be 
                released, otherwise OBJ_NIL.
    ...
    )
    {
        ...
        //this = (OBJ_ID)obj_Init(this, cbSize, OBJ_IDENT_LEX05);
        if (OBJ_NIL == this) {
            DEBUG_BREAK();
            obj_Release(this);
            return OBJ_NIL;
        ...
        obj_setVtbl(this, (OBJ_IUNKNOWN *)&Lex05_Vtbl);
...
//#if defined(__APPLE__)
        fprintf(
                stderr, 
                "Lex05::sizeof(LEX05_DATA) = %lu\n", 
                sizeof(LEX05_DATA)
        );
#endif
        BREAK_NOT_BOUNDARY4(sizeof(LEX05_DATA));
#endif
...
#else
        if (obj_Trace(this)) {
            ASTR_DATA       *pStr = Token_ToString(Lex_getToken(Lex05_getLex(this)));
            TRC_OBJ(this, "...Lex05_ParseToken token=%s", AStr_getData(pStr));
            obj_Release(pStr);
        }
#endif
        return eRc;
    ...
    /*!
     ...
     @code
        ...
        void        *pMethod = Lex05_QueryInfo(this, OBJ_QUERYINFO_TYPE_METHOD, "xyz");
     @endcode 
    ...
    )
    {
        ...
        switch (type) {
            ...
            case OBJ_QUERYINFO_TYPE_OBJECT_SIZE:
                return (void *)sizeof(LEX05_DATA);
                break;
            
            case OBJ_QUERYINFO_TYPE_CLASS_OBJECT:
                return (void *)Lex05_Class();
                break;
                ...
                switch (*pStr) {
                    ...
                    case 'P':
                        ...
                        if (str_Compare("ParseJsonFields", (char *)pStr) == 0) {
                            return Lex05_ParseJsonFields;
                        }
                        if (str_Compare("ParseJsonObject", (char *)pStr) == 0) {
                            return Lex05_ParseJsonObject;
                        }
#endif
                        break;
                    ...
                    case 'T':
                        if (str_Compare("ToDebugString", (char *)pStr) == 0) {
                            return Lex05_ToDebugString;
                        }
#ifdef  LEX05_JSON_SUPPORT
                        if (str_Compare("ToJsonFields", (char *)pStr) == 0) {
                            return Lex05_ToJsonFields;
                        }
            ...
            case OBJ_QUERYINFO_TYPE_PTR:
                if (pData == Lex05_ToDebugString)
                    return "ToDebugString";
#ifdef  LEX05_JSON_SUPPORT
                if (pData == Lex05_ToJson)
                    return "ToJson";
#endif
                break;
    ...
    )
    {
        ...
        //          in 'this' yet.
       if (this) {
            if (obj_IsKindOf(this, OBJ_IDENT_LEX05))
                ;
            else {
        ...
        if (!(obj_getSize(this) >= sizeof(LEX05_DATA))) {
            return false;
        }
