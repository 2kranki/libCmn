...
extern "C" {
    ...
    {
        ERESULT         eRc;
        FALSE_DATA   *pObject = OBJ_NIL;
        const
        OBJ_INFO        *pInfo;
        //int64_t         intIn;
        //ASTR_DATA       *pWrk;

        pInfo = obj_getInfo(False_Class());
        ...
        eRc =  False_ParseJsonFields(pParser, pObject);
    ...
    )
    {
        ...
        pObject = False_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = False_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = False_ToJsonFields(this, pStr);      
