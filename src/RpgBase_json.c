...
extern "C" {
    ...
    )
    {
        ...
        pInfo = obj_getInfo(RpgBase_Class());
        ...
        eRc =  RpgBase_ParseJsonFields(pParser, pObject);
    ...
    )
    {
        ...
        pObject = RpgBase_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = RpgBase_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = RpgBase_ToJsonFields(this, pStr);      
