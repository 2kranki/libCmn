...
typedef struct objList_class_data_s OBJLIST_CLASS_DATA;
...
OBJLIST_CLASS_DATA  objList_ClassObj = {
    {&obj_Vtbl, sizeof(OBJ_DATA), OBJ_IDENT_OBJLIST_CLASS, 0, 1},
	//0
};
