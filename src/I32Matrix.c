...
extern "C" {
...
#ifdef XYZZY
    static
    void            I32Matrix_task_body (
        void            *pData
    )
    {
        //I32MATRIX_DATA  *this = pData;
    ...
    ****************************************************************/
    ...
    uint16_t        I32Matrix_getPriority (
        I32MATRIX_DATA     *this
    )
    {
    ...
    )
    {
        ...
        this = (OBJ_ID)obj_Init(this, cbSize, OBJ_IDENT_I32MATRIX);
        if (OBJ_NIL == this) {
            DEBUG_BREAK();
            obj_Release(this);
            return OBJ_NIL;
