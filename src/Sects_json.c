...
extern "C" {
    ...
    )
    {
        ...
        eRc =  Sects_ParseJsonFields(pParser, pObject);
    ...
    )
    {
        ...
        pObject = Sects_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = Sects_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = Sects_ToJsonFields(this, pStr);      
