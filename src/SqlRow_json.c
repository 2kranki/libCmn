...
extern "C" {
    ...
    )
    {
        ...
        pInfo = obj_getInfo(SqlRow_Class());
        ...
        eRc =  SqlRow_ParseJsonFields(pParser, pObject);
    ...
    )
    {
        ...
        pObject = SqlRow_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = SqlRow_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = SqlRow_ToJsonFields(this, pStr);      
