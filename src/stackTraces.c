...
//
// From: https://gist.github.com/jvranish/4441299
//
// Since someone asked:
// I put this code in the public domain. As such you can use
// it without restrictions, but I provide no warranty as to 
// its usefulness or fitness for any purpose.
