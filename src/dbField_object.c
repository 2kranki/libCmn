...
static
bool            dbField_ClassIsKindOf(
    uint16_t		classID
)
{
    if (OBJ_IDENT_DBFIELD_CLASS == classID) {
       return true;
    }
...
{
    return OBJ_IDENT_DBFIELD_CLASS;
}
...
static
bool            dbField_IsKindOf(
    uint16_t		classID
)
{
    if (OBJ_IDENT_DBFIELD == classID) {
       return true;
    }
...
{
    return (OBJ_ID)&dbField_ClassObj;
}


static
uint16_t		dbField_WhoAmI(
    OBJ_ID          objId
)
{
    return OBJ_IDENT_DBFIELD;
}
