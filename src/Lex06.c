...
extern "C" {
...
#ifdef XYZZY
    static
    void            Lex06_task_body (
        void            *pData
    )
    {
        //LEX06_DATA  *this = pData;
    ...
    ****************************************************************/
    ...
    {
        LEX06_DATA       *this;
        uint32_t        cbSize = sizeof(LEX06_DATA);
    ...
    /*!
     ...
     Example:
     @code 
        ERESULT eRc = Lex06_Assign(this,pOther);
     @endcode 
     @param     this    object pointer
     @param     pOther  a pointer to another LEX06 object
    ...
    /*!
     ...
     Example:
     @code 
        Lex06      *pCopy = Lex06_Copy(this);
     @endcode 
     @param     this    object pointer
     @return    If successful, a LEX06 object which must be 
...
#ifdef LEX06_IS_IMMUTABLE
        obj_Retain(this);
        pOther = this;
#else
        pOther = Lex06_New( );
        if (pOther) {
            eRc = Lex06_Assign(this, pOther);
    ...
    )
    {
        ...
        if (obj_IsEnabled(this)) {
            ((LEX06_VTBL *)obj_getVtbl(this))->devVtbl.pStop((OBJ_DATA *)this,NULL);
        }
#endif

        Lex06_setStr(this, OBJ_NIL);
    ...
    /*!
     ...
     Example:
     @code 
        Lex06      *pDeepCopy = Lex06_Copy(this);
     @endcode 
     @param     this    object pointer
     @return    If successful, a LEX06 object which must be 
                released, otherwise OBJ_NIL.
    ...
    )
    {
        ...
        //this = (OBJ_ID)obj_Init(this, cbSize, OBJ_IDENT_LEX06);
        if (OBJ_NIL == this) {
            DEBUG_BREAK();
            obj_Release(this);
            return OBJ_NIL;
        ...
        obj_setVtbl(this, (OBJ_IUNKNOWN *)&Lex06_Vtbl);
...
//#if defined(__APPLE__)
        fprintf(
                stderr, 
                "Lex06::sizeof(LEX06_DATA) = %lu\n", 
                sizeof(LEX06_DATA)
        );
#endif
        BREAK_NOT_BOUNDARY4(sizeof(LEX06_DATA));
#endif
    ...
    /*!
     ...
     @code
        ...
        void        *pMethod = Lex06_QueryInfo(this, OBJ_QUERYINFO_TYPE_METHOD, "xyz");
     @endcode 
    ...
    )
    {
        ...
        switch (type) {
            ...
            case OBJ_QUERYINFO_TYPE_PTR:
                if (pData == Lex06_ToDebugString)
                    return "ToDebugString";
#ifdef  LEX06_JSON_SUPPORT
                if (pData == Lex06_ToJson)
                    return "ToJson";
#endif
                break;
    ...
    )
    {
        ...
        //          in 'this' yet.
       if (this) {
            if (obj_IsKindOf(this, OBJ_IDENT_LEX06))
                ;
            else {
        ...
        if (!(obj_getSize(this) >= sizeof(LEX06_DATA))) {
            return false;
        }
