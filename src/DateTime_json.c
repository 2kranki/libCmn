...
extern "C" {
    ...
    )
    {
        ...
        pObject = DateTime_New( );
        if (OBJ_NIL == pObject) {
            goto exit00;
        }
        
        eRc =  DateTime_ParseJsonFields(pParser, pObject);
    ...
    )
    {
        ...
        pObject = DateTime_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = DateTime_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
