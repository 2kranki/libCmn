...
extern "C" {
    ...
    )
    {
        ...
        eRc =  Number_ParseJsonFields(pParser, pObject);
    ...
    )
    {
        ...
        pObject = Number_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = Number_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = Number_ToJsonFields(this, pStr);      
