...
#ifndef SYMLIST_INTERNAL_H
#define SYMLIST_INTERNAL_H
...
#pragma pack(pop)
    ...
    extern
    struct SymList_class_data_s  SymList_ClassObj;
     ...
     */
    SYMLIST_DATA *       SymList_ParseJsonObject (
        JSONIN_DATA     *pParser
    );
    ...
    /*!
     ...
     @return    If successful, ERESULT_SUCCESS. Otherwise, an ERESULT_*
                error code.
     */
    ERESULT         SymList_ParseJsonFields (
        JSONIN_DATA     *pParser,
        SYMLIST_DATA     *pObject
    );
#endif
