...
extern "C" {
    ...
    )
    {
        ...
        if (ERESULT_OK(eRc)) {
            ...
            if (pWrk) {
                ChkSumMD5_setErrorStr(pObject, pWrk);
                obj_Release(pWrk);
            }
    ...
    {
        ERESULT         eRc;
        CHKSUMMD5_DATA   *pObject = OBJ_NIL;
        const
        OBJ_INFO        *pInfo;
        //int64_t         intIn;
        //ASTR_DATA       *pWrk;
        ...
        pInfo = obj_getInfo(ChkSumMD5_Class());
        ...
        pObject = ChkSumMD5_New( );
        if (OBJ_NIL == pObject) {
            goto exit00;
        }
        
        eRc =  ChkSumMD5_ParseJsonFields(pParser, pObject);
        if (ERESULT_FAILED(eRc)) {
            obj_Release(pObject);
            pObject = OBJ_NIL;
        }
    ...
    )
    {
        ...
        pObject = ChkSumMD5_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = ChkSumMD5_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = ChkSumMD5_ToJsonFields(this, pStr);      
