...
extern "C" {
...
#ifdef XYZZY
    static
    void            I16Matrix_task_body (
        void            *pData
    )
    {
        //I16MATRIX_DATA  *this = pData;
    ...
    ****************************************************************/
    ...
    uint16_t        I16Matrix_getPriority (
        I16MATRIX_DATA     *this
    )
    {
    ...
    )
    {
        ...
        this = (OBJ_ID)obj_Init(this, cbSize, OBJ_IDENT_I16MATRIX);
        if (OBJ_NIL == this) {
            DEBUG_BREAK();
            obj_Release(this);
            return OBJ_NIL;
