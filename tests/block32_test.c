...
TINYTEST_START_SUITE(test_block32);
  TINYTEST_ADD_TEST(test_block32_OpenClose,setUp,tearDown);
TINYTEST_END_SUITE();

TINYTEST_MAIN_SINGLE_SUITE(test_block32);
