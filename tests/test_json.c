...
TINYTEST_START_SUITE(test_json);
  TINYTEST_ADD_TEST(test_json_Input03,setUp,tearDown);
  TINYTEST_ADD_TEST(test_json_Input02,setUp,tearDown);
  TINYTEST_ADD_TEST(test_json_Input01,setUp,tearDown);
  TINYTEST_ADD_TEST(test_json_OpenClose,setUp,tearDown);
TINYTEST_END_SUITE();

TINYTEST_MAIN_SINGLE_SUITE(test_json);
