...
TINYTEST_START_SUITE(test_memOSX);
  TINYTEST_ADD_TEST(test_memOSX_Tests02,setUp,tearDown);
  TINYTEST_ADD_TEST(test_memOSX_Tests01,setUp,tearDown);
  TINYTEST_ADD_TEST(test_memOSX_OpenClose,setUp,tearDown);
TINYTEST_END_SUITE();

TINYTEST_MAIN_SINGLE_SUITE(test_memOSX);
